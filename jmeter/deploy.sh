...
NS="${NS:-performance-testing}"        # namespace "Default value performance-testing"
...
echo
 ...
 echo "Checking ${1:-$NS} namespace availabilty"
...
kubectl get -n ${1:-$NS} all -o wide | grep ${2:-$PNAME}
